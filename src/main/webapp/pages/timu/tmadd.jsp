                ...
                <li class="nav-item active">
                    ...
                    <div class="collapse" id="charts">
                        <ul class="nav flex-column sub-menu">
                            ...
                            <li class="nav-item active"> <a class="nav-link" href="../timu/tmadd.jsp">添加题目</a></li>
                        </ul>
                    </div>
                </li>
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-description">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name=""  class="form-control qid" id="exampleInputUsername2">
                                            <option value="" selected>请选择对应题库</option>
                                        </select>
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputUsername2">题目类型</label>
                                        <select name=""  class="form-control type" id="exampleInputUsername2">
                                            <option value="" selected>请选择对应的类型</option>
                                            <option value="schose">单选</option>
                                    ...
                                    <button class="btn btn-primary me-2 " onclick="addtm()">添加</button>
                                    <button class="btn btn-light" onclick="cancelAdd()">取消</button>
                            </div>
                        </div>
                    </div>
