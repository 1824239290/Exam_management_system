            ...
            <div class="content-wrapper">
                <div class="row">
                    <div class="grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">题目详情</h4>
                                <div class="form-group">
                                    <label for="exampleInputUsername1">题目描述</label>
                                    <input type="text" class="form-control name" id="exampleInputUsername1" placeholder="题目描述" readonly>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control optionA" id="exampleInputUsername3" placeholder="选项A" readonly>
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputUsername4">选项B</label>
                                    <input type="text" class="form-control optionB" id="exampleInputUsername4" placeholder="选项B" readonly>
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputUsername5">选项C</label>
                                    <input type="text" class="form-control optionC" id="exampleInputUsername5" placeholder="选项C" readonly>
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputUsername6">选项D</label>
                                    <input type="text" class="form-control optionD" id="exampleInputUsername6" placeholder="选项D" readonly>
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputUsername8">正确选项</label>
                                    <input type="text" class="form-control answer" id="exampleInputUsername8" placeholder="请输入选项名" readonly>
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputUsername7">解析</label>
                                    <input type="text" class="form-control analysis" id="exampleInputUsername7" placeholder="解析内容" readonly>
                                </div>
        ...
        if (type==="schose"){
            axios({
                ...
                if (res.data.code==200){
                    ...
                    document.getElementById("exampleInputUsername2").value=data1.qname;
