                ...
                <li class="nav-item active">
                    ...
                    <div class="collapse" id="charts">
                        <ul class="nav flex-column sub-menu">
                            ...
                            <li class="nav-item  active "> <a class="nav-link" href="#">多选题列表</a></li>
...
<script>
        ...
        axios({
            ...
            $.each(data1,function (k,v){
                html +=`<tbody>
                        <tr>
                          <td>${data1[k].mid}</td>
                          <td><span>${data1[k].mname}</span></td>
                          <td>${data1[k].qname}</td>
                          <td>${data1[k].answer}</td>
                          <td><span>${data1[k].analysis}</span></td>
                          <td>
                          <button type="button" class="btn btn-success" onclick="change('detail.jsp',${data1[k].mid})">详情</button>
                          <button type="button" class="btn btn-warning" onclick="change('update.jsp',${data1[k].mid})">修改</button>
                          <button type="button" class="btn btn-danger" onclick="deletebyid(${data1[k].mid})">删除</button>
                          </td>
                        </tr>
                      </tbody>`
            });
    ...
    function change(href,mid) {
        location.href=`/pages/timu/${href}?id=${mid}&type=multiple`;
    };
</script>
</body>
