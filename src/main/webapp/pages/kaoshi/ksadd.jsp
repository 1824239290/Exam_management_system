...
<div class="container-scroller">
            ...
            <ul class="nav">
                ...
                <li class="nav-item active">
                    ...
                    <div class="collapse" id="tables">
                        <ul class="nav flex-column sub-menu">
                            <li class="nav-item"> <a class="nav-link" href="./kslist.jsp">试卷管理</a></li>
                            <li class="nav-item active"> <a class="nav-link" href="#">添加试卷</a></li>
                        </ul>
                    </div>
                </li>
            </ul>
            ...
            <div class="content-wrapper">
                <div class="row">
                    <div class="grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">生成</h4>
                                <p class="card-description">
                                    请输入试卷相关信息
                                </p>
                                    <div class="form-group">
                                        <label for="selecttype">目标题库</label>
                                        <select name="" id="selecttype" class="form-control">

                                        </select>
                                    </div>
                                    <div class="form-group">
                                        <label for="tpname">试卷名称</label>
                                        <input type="text" class="form-control" id="tpname"
                                               placeholder="试卷名称">
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputUsername2">注：</label>
                                        <input type="text" class="form-control" id="exampleInputUsername2" value="试卷为在指定题库自动随机生成，包含20道单选题，10道判断题，4道多选题，共34道题目。" disabled>
                                    </div>
                                    <button type="submit" class="btn btn-primary me-2" onclick="addTestPaper()">生成</button>
                                    <button class="btn btn-light" onclick="history.back()">取消</button>
                            </div>
                        </div>
                    </div>
    ...
    function getTiku() {
        axios({
            ...
            if (res.data.code == 200) {
                ...
                console.log(res)
                console.log(data1)
                var html = `<option value="0" selected>请选择对应题库</option>`;
                $.each(data1, function (k, v) {
                    html +=
                        ` <option value="${data1[k].id}">${data1[k].name}</option>`
                });
    ...
    function addTestPaper(){
        ...
        axios({
            ...
            if (res.data.code == 200){
                alert(res.data.msg);
                window.location.href="/pages/kaoshi/kslist.jsp"
            }
        })
    }
    </script>
