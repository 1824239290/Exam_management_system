            ...
            <ul class="nav">
                ...
                <li class="nav-item active">
                    ...
                    <div class="collapse" id="tables">
                        <ul class="nav flex-column sub-menu">
                            <li class="nav-item active"> <a class="nav-link" href="#">试卷管理</a></li>
            ...
            <div class="content-wrapper">
                <div class="row">
                    <div class="grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">考试管理</h4>
                                <a href="../kaoshi/ksadd.jsp"><button type="button" class="btn btn-success btn-md">生成试卷</button></a>
...
<script>
            ...
            $.each(data1,function (k,v){
                html +=`<tbody>
                        <tr>
                          ...
                          <td>${data1[k].date}</td>
                          <td>
                          <button type="button" class="btn btn-success" onclick="detail(${data1[k].pid})">详情</button>
                          <button type="button" class="btn btn-danger" onclick="deleteTestPaper(${data1[k].pid})">删除</button>
                          </td>
                        </tr>
                      </tbody>`
            });
    ...
    function detail(pid) {
        window.location.href="/pages/kaoshi/ksdetail.jsp?tpid="+pid;
    }
</script>
</body>
