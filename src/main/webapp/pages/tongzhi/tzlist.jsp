            ...
            <ul class="nav">
                ...
                <li class="nav-item active">
                    ...
                    <div class="collapse" id="form-elements">
                        <ul class="nav flex-column sub-menu">
                            <li class="nav-item active"><a class="nav-link" href="#">通知管理</a></li>
            ...
            <div class="content-wrapper">
                <div class="row">
                    <div class="grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">通知管理</h4>
                                <a href="../tongzhi/tzadd.jsp"><button type="button" class="btn btn-success btn-md">发布通知</button></a>
...
<script>
    ...
    function deletebyid(nid){
        ...
        axios({
            ...
            if (res.data.code == 200){
                alert(res.data.msg);
                window.location.href = "/pages/tongzhi/tzlist.jsp"
            }
        })
    }
    //发送查全部ajax请求
        ...
        axios({
            ...
            $.each(data1,function (k,v){
                html +=`<tbody>
                        <tr>
                          <td>${data1[k].nid}</td>
                          <td><span>${data1[k].title}</span></td>
                          <td><span>${data1[k].contents}</span></td>
                          <td>${data1[k].created_time}</td>
                          <td>
                          <button type="button" class="btn btn-success" onclick="change('tzdetail.jsp',${data1[k].nid})">详情</button>
                          <button type="button" class="btn btn-warning" onclick="change('tzupdate.jsp',${data1[k].nid})">修改</button>
                          <button type="button" class="btn btn-danger" onclick="deletebyid(${data1[k].nid})">删除</button>
                          </td>
                        </tr>
                      </tbody>`
            });[]
    ...
    function change(href,nid) {
        location.href=`/pages/tongzhi/${href}?nid=${nid}`;
    };
</script>
</body>
