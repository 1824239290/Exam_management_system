            ...
            <div class="content-wrapper">
                <div class="row">
                    <div class="grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">通知详情</h4>
                                <div class="form-group">
                                    <label for="exampleInputUsername1">标题</label>
                                    <input type="text" class="form-control ntitle" id="exampleInputUsername1" placeholder="请输入标题"  readonly>
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputUsername2">通知内容</label>
                                    <input type="text" class="form-control  ndesc" id="exampleInputUsername2" placeholder="请输入内容" readonly>
                                </div>
