                ...
                <li class="nav-item active">
                    ...
                    <div class="collapse" id="form-elements">
                        <ul class="nav flex-column sub-menu">
                            ...
                            <li class="nav-item active"><a class="nav-link" href="#">发布通知</a></li>
                        </ul>
                    </div>
                </li>
                <li class="nav-item">
            ...
            <div class="content-wrapper">
                <div class="row">
                    <div class="grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">修改通知</h4>
                                <p class="card-description">
                                    请输入通知相关信息
                                </p>
                                <div class="form-group">
                                    <label for="exampleInputUsername1">标题</label>
                                    <input type="text" class="form-control ntitle" id="exampleInputUsername1" placeholder="请输入标题"  >
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputUsername2">通知内容</label>
                                    <input type="text" class="form-control  ndesc" id="exampleInputUsername2" placeholder="请输入内容" >
                                </div>
                                <button class="btn btn-primary me-2" onclick="updateNotify()">更新</button>
                                <button class="btn btn-light" onclick="back()">返回</button>
                            </div>
                        </div>
                    </div>
...
<script>
    var data1={};
    var  nid=window.location.search;
    nid=nid.replace(/[^\d]/g,"");
    function detail(){
        axios({
            method:"get",
            ...
            if (res.data.code==200){
                data1=res.data.data;
                document.getElementById("exampleInputUsername1").value=data1.title;
                document.getElementById("exampleInputUsername2").value=data1.contents;
            }else{
                alert(res.data.msg);
            }
        })
    ...
    function back(){
        window.location.href="./tzlist.jsp"
    }
