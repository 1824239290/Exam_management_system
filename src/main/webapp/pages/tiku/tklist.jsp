                ...
                <li class="nav-item active">
                    ...
                    <div class="collapse" id="ui-basic">
                        <ul class="nav flex-column sub-menu">
                            <li class="nav-item active"> <a class="nav-link" href="#">题库列表</a></li>
                    ...
                    <div class="grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <a href="../tiku/tkadd.jsp"><button type="button" class="btn btn-success btn-md">添加题库</button></a>
...
<script>
    //延迟100自动执行
    // setTimeout(function () { getAll() }, 100);
    //发送删除Ajax
    function deletebyid(id){
        var qid = id
        axios({
            method:"delete",
            url:"/Qustionbanks/"+qid
        }).then(function (res){
            if (res.data.code == 200){
                alert(res.data.msg);
                window.location.href = "/pages/tiku/tklist.jsp"
            }
        })
    }
    //发送查全部ajax请求
            ...
            $.each(data1,function (k,v){
                html +=     `<tbody>
                        <tr>
                          ...
                          <td>${data1[k].name}</td>
                          <td>${data1[k].desc}</td>
                          <td><button type="button" class="btn btn-danger" onclick="deletebyid(${data1[k].id})">删除</button></td>
                        </tr>
                      </tbody>`
            });
            $("#table").append(html)
