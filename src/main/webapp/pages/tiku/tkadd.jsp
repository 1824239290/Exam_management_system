                ...
                <li class="nav-item active">
                    ...
                    <div class="collapse" id="ui-basic">
                        <ul class="nav flex-column sub-menu">
                            ...
                            <li class="nav-item active"> <a class="nav-link" href="#">添加题库</a></li>
                        </ul>
                    </div>
                </li>
                <li class="nav-item">
            ...
            <div class="content-wrapper">
                <div class="row">
                    <div class="grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">添加题库</h4>
                                <p class="card-description">
                                    请输入题库相关信息
                                </p>

                                <div class="form-group">
                                    <label for="name">题库名</label>
                                    <input type="text" class="form-control" id="name" placeholder="题库名">
                                </div>
                                <div class="form-group">
                                    <label for="desc">题库描述</label>
                                    <input type="text" class="form-control" id="desc" placeholder="题库描述">
                                </div>
                                <button class="btn btn-primary me-2" onclick="addQbank()">添加</button>
    ...
    function addQbank(){
        ...
        axios({
            ...
            if (res.data.code==200){
                alert(res.data.msg)
                window.location.href="./tklist.jsp"
            }
        })
    }
    function cancelAdd(){
